...
On a computer with git installed, clone the repository. Adjust the URLs in index.htm and respective player[x].htm files to the appropriate movie files. Open a browser and point it to the directory in which you cloned the repo, et voila!
